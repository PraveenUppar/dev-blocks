...
export async function getPublishedPostByIdService(id, userId) {
...
export async function getPublishedPostBySlugService(slug, userId) {
    const post = await prisma.post.findUnique({
        where: {
            slug,
            deletedAt: null,
...
export async function getDraftPostByIdService(id, userId) {
    const post = await prisma.post.findUnique({
        where: {
            id,
            authorId: userId,
...
export async function publishPostService(postId, userId) {
    return prisma.post.update({
...
export async function getLikeCountService(postId) {
